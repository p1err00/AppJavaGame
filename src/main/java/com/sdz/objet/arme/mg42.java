 ...
 * @author pierr
 */
public class mg42 extends Arme{
    Scanner sc = new Scanner(System.in);
    public mg42() {
        joueur.force=joueur.force+300;
        this.type="Fusil mitrailleur";
        this.classeEquipe="Soutient";
        this.couleur="Noir";
        this.poid=7800;
    ...
    public String Description(){
        return "Un fusil-mitrailleur à toute epreuve\n"
